...
type Estimate = { label: string; priceEx: string; priceIncl: string; amountEx: number };
function getEstimate(data: IntakeData): Estimate {
  ...
  if (score <= 1) return { label: "Compacte opdracht", priceEx: "vanaf €440", priceIncl: "€532,40", amountEx: 440 };
  if (score <= 3) return { label: "Standaard opdracht", priceEx: "vanaf €880", priceIncl: "€1.064,80", amountEx: 880 };
  if (score <= 5) return { label: "Uitgebreide opdracht", priceEx: "vanaf €1.320", priceIncl: "€1.597,20", amountEx: 1320 };
  return { label: "Meerdaagse opdracht", priceEx: "vanaf €1.760", priceIncl: "€2.129,60", amountEx: 1760 };
}
...
export default function Contact() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    const message = [
      ...
      `Prijsindicatie website: ${estimate.priceEx} excl. btw / ${estimate.priceIncl} incl. btw (${estimate.label})`,
