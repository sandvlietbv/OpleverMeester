...
const tiers = [
  ...
  ["Meerdaagse opdracht", "vanaf €1.760", "Een grotere of complexere oplevering met extra inzet of afvoer."],
];
    ...
    <section id="prijzen" className="bg-surface-light py-16 md:py-20">
      <div className="container-om">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 leading-relaxed text-muted">We werken met projectprijzen. De bedragen hieronder zijn vanafprijzen inclusief btw. Via de intake maken we de indicatie specifieker op basis van de ruimte, omvang, bereikbaarheid en planning.</p>
        </div>
        <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          {tiers.map(([label, price, text]) => (
            <article key={label} className="rounded-om border border-surface-mid bg-white p-6">
              ...
              <p className="mt-2 font-display text-3xl font-semibold tracking-tight text-navy">{price}</p>
