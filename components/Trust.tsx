      ...
      <div className="container-om">
        <div className="grid gap-10 lg:grid-cols-[1fr_.9fr] lg:items-start">
          <div>
            ...
            <p className="mt-4 max-w-2xl leading-relaxed text-muted">We zijn een jonge onderneming. Daarom doen we geen alsof-verhalen en plaatsen we geen verzonnen reviews. Vertrouwen bouwen we met duidelijke afspraken, bereikbaarheid en zichtbaar resultaat.</p>
