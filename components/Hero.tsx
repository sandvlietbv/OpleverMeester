    ...
    <section className="bg-navy text-white">
      <div className="container-om grid min-h-[66vh] items-center gap-10 py-16 md:py-20 lg:grid-cols-[1.25fr_.75fr]">
        <div>
          ...
          <motion.div initial="hidden" animate="show" custom={0.18} variants={fadeUp} className="mt-8"><a href="#intake" className="inline-flex rounded-om bg-orange px-7 py-3.5 text-center font-semibold text-white hover:bg-orange-light">Start intake</a></motion.div>
        </div>
