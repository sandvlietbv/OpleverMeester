...
export const metadata: Metadata = {
  title: "Woningontruiming Groningen | Vanaf €440 incl. btw",
...
const JSON_LD = {
  ...
  provider: {
    ...
    address: { "@type": "PostalAddress", streetAddress: "Lijsterbeslaan 43", addressLocality: "Groningen", addressCountry: "NL" },
  },
    ...
    <main>
      <section className="bg-navy py-16 text-white md:py-24">
        <div className="container-om max-w-5xl">
          ...
          <p className="mt-4 text-sm text-white/55">Indicatieve projectprijzen beginnen vanaf €440 inclusief btw.</p>
        </div>
      </section>
