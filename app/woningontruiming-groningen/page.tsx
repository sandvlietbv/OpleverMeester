...
export const metadata: Metadata = {
  title: "Woningontruiming Groningen | Vanaf €440 excl. btw",
    ...
    <main>
      <section className="bg-navy py-16 text-white md:py-24">
        <div className="container-om max-w-5xl">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-white/75 md:text-xl">OpleverMeester heeft zijn basis in Groningen. Moet een woning leeg vanwege verhuizing, overlijden, verkoop of einde huur, dan kijken we eerst naar de woning, bereikbaarheid en deadline en maken daar één opleverplan van.</p>
          ...
          <p className="mt-4 text-sm text-white/55">Indicatieve projectprijzen beginnen vanaf €440 excl. btw (€532,40 incl. btw voor consumenten).</p>
        </div>
      </section>
