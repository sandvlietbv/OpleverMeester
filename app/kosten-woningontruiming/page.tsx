...
export const metadata: Metadata = {
  title: "Kosten woningontruiming | Vanaf €440 incl. btw",
  description: "Wat kost een woningontruiming? Bekijk projectprijzen vanaf €440 inclusief btw en krijg via de intake een indicatie op basis van uw situatie.",
  alternates: { canonical: "/kosten-woningontruiming" },
};

const tiers = [
  ["Compacte opdracht", "vanaf €440", "Beperkte ontruiming, enkele opleverpunten of een kleine ruimte."],
  ["Standaard opdracht", "vanaf €880", "Een normale woning of appartement met meerdere werkzaamheden."],
  ["Uitgebreide opdracht", "vanaf €1.320", "Een grotere woning, meer inboedel of meerdere opleverwerkzaamheden."],
  ["Meerdaagse opdracht", "vanaf €1.760", "Grotere of complexere oplevering met extra inzet, bereikbaarheid of afvoer."],
];
