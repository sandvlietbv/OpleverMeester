...
export default function Page() {
  return <>
    ...
    <main>
      ...
      <section className="bg-surface-light py-16 md:py-20"><div className="container-om max-w-4xl"><h2 className="font-display text-3xl font-semibold text-navy">Van dossier naar één praktisch oplevertraject.</h2><p className="mt-4 leading-relaxed text-muted">U hoeft geen complete werkomschrijving te maken. Adres, deadline, toegang en wat u al weet over inboedel en eindstaat zijn genoeg om te beginnen. Wij brengen vervolgens in beeld welke combinatie van leeghalen, afvoer, schoonmaak, verwijderen van onderdelen en afgesproken opleverpunten nodig is.</p><a href="#intake" className="mt-7 inline-block rounded-om bg-orange px-6 py-3 font-semibold text-white">Leg het dossier voor →</a></div></section>
