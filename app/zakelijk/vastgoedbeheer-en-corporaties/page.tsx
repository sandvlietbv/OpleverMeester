...
export default function Page() {
  return <>
    ...
    <main>
      ...
      <VisualProof src="/images/visual-proof/vastgoed-corporaties.webp" alt="Neutrale galerijwoning tussen twee huurders" eyebrow="Mutatie en leegstand" title="Een gewone woning, klaar voor de volgende gebruiksfase." text="We sluiten aan op de daadwerkelijke staat van de mutatiewoning en op uw opleverproces, zonder van iedere ruimte een standaardopdracht te maken." imageFirst imagePosition="center 48%" />
